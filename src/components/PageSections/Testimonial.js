  ...
  return (
    <div className='py-8 bg-white lg:py-6'>
      <div className='relative px-4 mx-auto max-w-7xl sm:px-6 lg:px-8'>
        <div className='relative px-8 py-24 overflow-hidden shadow-xl bg-gradient-to-r from-amber-700/70 via-amber-700/40 to-yellow-900/70 rounded-xl lg:px-16 lg:grid lg:grid-cols-2 lg:gap-x-8'>
